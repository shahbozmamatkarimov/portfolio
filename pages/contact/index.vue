  ...
  <main class="min-h-screen mb-10">
    <section class="contact flex justify-center gap-5 z-10">
      <div class="text-center rounded bg-white min-w-fit w-72 z-10 px-5 py-7">
        <button
          class="text-[#faab0d] border-2 border-[#faab0d] rounded-full text-2xl hover:bg-[#faab0d] hover:text-white duration-700 px-3 py-2"
        >
          <i class="bx bx-map"></i>
        </button>
    ...
    <section class="flex justify-center">
      <form
        class="flex flex-col justify-center rounded items-center bg-[#faab0d] gap-5 w-[40rem] pt-24 pb-10 -mt-12"
      >
        <h1
          class="md:text-3xl sm:text-2xl text-lg font-bold text-center text-white"
        >
          Send your message!
        </h1>
        <input
          class="w-[80%] border-2 border-gray-300 bg-white outline-none p-1 rounded required"
          type="text"
...
store.location = "Tashkent, Chilonzor, 9 ST";
